 ...
 * @version 5/30/2017
 */
public class RecommendAManuscriptPanel extends AutoSizeablePanel {
	...
	public static void main(String[] args){
		EventQueue.invokeLater(new Runnable() 
        {
            ...
            public void run() 
            {
                ...
                final JPanel mainPanel = new RecommendAManuscriptPanel(1, 1, new Dimension(800, 600));
	...
	public RecommendAManuscriptPanel(
			double theXRatio,
			double theYRatio,
...
//		}
		...
		List<Manuscript> legalManuscripts = getLegalManuscript();
		for(Manuscript m: legalManuscripts){
	...
	private List<Manuscript> getLegalManuscript() {
		...
		for(Manuscript manuscript:conference.getManuscripts()){
			System.out.println(manuscript.getReviews().size());
